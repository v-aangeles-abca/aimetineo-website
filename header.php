...
<nav id="main-nav">
  ...
  <div class="nav-links" id="nav-links">
    ...
    <a href="<?php echo esc_url($front . '#about'); ?>">About</a>
    <a href="<?php echo esc_url($front . '#services'); ?>">Services</a>
    <a href="<?php echo esc_url($coaching_url); ?>" class="nav-coaching">Coaching ✦</a>
    <a href="<?php echo esc_url($front . '#contact'); ?>" class="nav-cta">Work With Me</a>
  </div>
