...
<section class="c-hero">
  <div class="c-hero-text">
    <div class="c-badge">✦ UGC Creator Coaching</div>
    ...
    <div class="c-hero-proof">
      ...
      <div class="proof-item"><div class="proof-num">3yr</div><div class="proof-label">Experience</div></div>
      <div class="proof-item"><div class="proof-num">EN/ES</div><div class="proof-label">Bilingual</div></div>
    </div>
  </div>
  <div class="c-hero-img">
    <img src="<?php echo esc_url("$t/assets/img/about2.jpg"); ?>" alt="Aimé Tineo — UGC Coach" loading="eager">
    <div class="c-hero-card"><p>Next available</p><strong>Book your spot →</strong></div>
  </div>
</section>
...
<section class="for-whom">
  <div style="max-width:var(--max);margin:0 auto;">
    ...
    <div class="fw-grid">
      ...
      <div class="fw-card"><div class="fw-icon">🌍</div><h3>Bilingual Creators</h3><p>Leverage your Spanish skills to tap into a massive underserved market and double your brand deal opportunities.</p></div>
    </div>
  </div>
</section>
  ...
  <div style="max-width:var(--max);margin:0 auto;">
    ...
    <div class="off-grid">
      ...
      <div class="off-card featured">
        ...
        <div class="off-tag">Signature</div><div class="off-title">1-on-1 Coaching Session</div>
    ...
    <div class="curr-grid">
      <div>
        ...
        <div class="curr-list" style="margin-top:40px">
          ...
          <div class="curr-item"><div class="curr-num">03</div><div class="curr-content"><div class="curr-title">Pitching & Outreach Strategy</div><div class="curr-desc">Email templates, DM scripts, and the follow-up system that gets responses.</div></div></div>
          <div class="curr-item"><div class="curr-num">04</div><div class="curr-content"><div class="curr-title">Pricing & Negotiation</div><div class="curr-desc">How to set your rates, when to say no, and how to negotiate without losing the deal.</div></div></div>
          <div class="curr-item"><div class="curr-num">05</div><div class="curr-content"><div class="curr-title">The Bilingual Advantage</div><div class="curr-desc">Tap into a massive underserved pool of brand partnerships as a bilingual creator.</div></div></div>
        </div>
      </div>
      <div class="curr-img"><img src="<?php echo esc_url("$t/assets/img/about.jpg"); ?>" alt="Aimé coaching" loading="lazy"></div>
    </div>
  </div>
</section>
...
<section class="c-about">
  ...
  <div class="c-about-text">
    ...
    <div class="c-about-creds">
      <div class="cred">80+ brand collaborations in 3 years</div>
      <div class="cred">Bilingual English & Spanish creator</div>
      <div class="cred">19k+ Instagram · 11k+ TikTok</div>
      <div class="cred">Based in Rhode Island, USA</div>
    </div>
    <a href="#book" class="btn-gold-f" style="align-self:flex-start">Book a Session With Me</a>
  </div>
</section>
...
<section class="faq" id="faq">
  <div style="max-width:var(--max);margin:0 auto;">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item"><button class="faq-q">How are sessions delivered? <span class="faq-chevron">↓</span></button><div class="faq-a">Via Zoom video call. You'll receive a recorded copy after every session.</div></div>
      <div class="faq-item"><button class="faq-q">Which program is right for me? <span class="faq-chevron">↓</span></button><div class="faq-a">Book a free 15-min intro call — I'll tell you honestly which option fits your goals and budget.</div></div>
      <div class="faq-item"><button class="faq-q">What niches do you specialize in? <span class="faq-chevron">↓</span></button><div class="faq-a">Beauty, fashion, lifestyle, home, and wellness — but the core skills apply to any niche.</div></div>
    </div>
  </div>
</section>
...
<section class="c-cta" id="book">
  <div style="max-width:700px;margin:0 auto;text-align:center;">
    ...
    <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap;">
      <?php
      $form_page = get_page_by_path('coaching-form');
      $form_url  = $form_page ? get_permalink($form_page->ID) : home_url('/coaching-form/');
      ?>
      <a href="<?php echo esc_url($form_url); ?>" class="btn-dark-f" style="display:inline-flex;align-items:center;padding:16px 40px;border-radius:100px;background:var(--dark);color:var(--cream);font-size:15px;font-weight:500;text-decoration:none;">
        Reserva Tu Sesión ✦
      </a>
    </div>
    <p style="margin-top:20px;font-size:13px;color:var(--muted);">Or email: <a href="mailto:<?php echo esc_attr($email); ?>" style="color:var(--lavender);font-weight:500"><?php echo esc_html($email); ?></a></p>
  </div>
</section>
